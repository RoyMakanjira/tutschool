...
const YANDEX_MAPS_EMBED_URL = `https://yandex.com/maps/embed/10758/himki/?ll=37.374147%2C55.894611&mode=search&rtext=~${TUT_SCHOOL_COORDINATES}&rtt=auto&ruri=~&z=17`
...
const YandexMap = () => {
  ...
  return (
    <div className="relative w-full rounded-xl overflow-hidden shadow-lg border border-gray-200">
      ...
      <a
        href={`https://yandex.com/maps/?rtext=~${TUT_SCHOOL_COORDINATES}`}
        target="_blank"
