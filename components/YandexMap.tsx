...
const YANDEX_MAPS_BASE_URL = `https://yandex.com/maps/embed/10758/himki/?ll=37.374147%2C55.894611&z=17`
...
const YandexMap = () => {
  ...
  return (
    <div className="relative w-full rounded-xl overflow-hidden shadow-lg border border-gray-200">
      {/* Simple map display without directions */}
      <iframe
        src={YANDEX_MAPS_BASE_URL}
      ...
      {/* Floating open button (optional - keep if you want) */}
      <a
        href={`https://yandex.com/maps/?ll=${TUT_SCHOOL_COORDINATES}`}
        target="_blank"
