...
export default function ChineseTeenagersPage() {
  ...
  const translations = {
    ru: {
      ...
      schedule: "",
      duration: "60 минут каждое занятие",
      groupSize: "Мини-группы до 4 человек",
    ...
    en: {
      ...
      groupSize: "Mini-groups up to 4 people",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <meta property="og:title" content={`${t.h1} | ${t.schoolName}`} />
        <meta 
        ...
        <meta name="twitter:title" content={`${t.h1} | ${t.schoolName}`} />
        <meta 
