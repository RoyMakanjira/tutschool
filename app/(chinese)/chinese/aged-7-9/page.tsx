...
import {
  ...
  ArrowRight, Check, Landmark, Star, Music, Gamepad2
} from "lucide-react"
  ...
  const translations = {
      ...
      features: [
        {
          ...
          description: "Изучение языка через игры и интерактивные задания",
          icon: Gamepad2
        },
        {
          title: "Творческие проекты",
          description: "Развитие через рисование, поделки и музыку",
          icon: Music
        },
        {
          title: "Небольшие группы",
          description: "Занятия в группах до 6 человек",
          icon: Users
        },
        {
          title: "Сертификаты",
          description: "Награды за достижения и успехи",
          icon: Award
        }
      ],
      activities: [
        {
          ...
          description: "Чтение и инсценировка китайских народных сказок",
        ...
        },
        {
          ...
          description: "Изучение китайских песен и стихов",
          image: "https://images.pexels.com/photos/3768894/pexels-photo-3768894.jpeg"
        }
      ],
      levels: [
        {
          name: "Начальный",
          description: "Знакомство с китайским языком и культурой"
        },
        {
          name: "Базовый",
          description: "Основы китайского языка и простые фразы"
        },
        {
          name: "Продвинутый",
        ...
        plans: [
          {
            ...
            price: "1,000 ₽",
            features: ["1 занятие", "45 минут", "Группа до 6 человек"]
          },
          {
            name: "Абонемент на месяц",
            price: "3,500 ₽",
            features: ["8 занятий", "45 минут каждое", "Группа до 6 человек"],
            popular: true
          },
          {
            name: "Индивидуальное занятие",
            price: "1,500 ₽",
            features: ["1 занятие", "45 минут", "Индивидуальный подход"]
          }
        ]
      }
    },
    en: {
      hero: {
        ...
        subtitle: "Fun Chinese learning through games and creativity",
        cta: "Book a trial lesson"
      },
      features: [
        {
          title: "Game-based Learning",
          description: "Learning through games and interactive activities",
          icon: Gamepad2
        },
        {
          title: "Creative Projects",
          description: "Development through art, crafts and music",
          icon: Music
        },
        {
          title: "Small Groups",
          description: "Classes in groups of up to 6 children",
          icon: Users
        },
        {
          title: "Certificates",
          description: "Awards for achievements and progress",
          icon: Award
        }
      ],
      activities: [
        {
          ...
          description: "Reading and acting out Chinese folk tales",
          image: "https://images.pexels.com/photos/3768894/pexels-photo-3768894.jpeg"
        },
        {
        ...
        {
          title: "Music Classes",
          description: "Learning Chinese songs and poems",
          image: "https://images.pexels.com/photos/3768894/pexels-photo-3768894.jpeg"
        }
      ],
      levels: [
        {
          name: "Beginner",
          description: "Introduction to Chinese language and culture"
        },
        {
          name: "Basic",
          description: "Chinese language basics and simple phrases"
        },
        {
          name: "Advanced",
        ...
        plans: [
          {
            name: "Single Visit",
            price: "1,000 ₽",
            features: ["1 lesson", "45 minutes", "Group up to 6 children"]
          },
          {
            name: "Monthly Pass",
            price: "3,500 ₽",
            features: ["8 lessons", "45 minutes each", "Group up to 6 children"],
            popular: true
          },
          {
            name: "Individual Lesson",
            price: "1,500 ₽",
            features: ["1 lesson", "45 minutes", "Individual approach"]
          }
        ]
      }
    }
