...
export default function Aged10to12Page() {
  ...
  const translations = {
    ru: {
      ...
      activities: [
        { title: "Дебаты и дискуссии", description: "Развитие навыков аргументации и критического мышления на английском", image: "https://images.pexels.com/photos/8612967/pexels-photo-8612967.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
        ...
        { title: "Подготовка к экзаменам", description: "Систематическая подготовка к международным экзаменам", image: "https://images.pexels.com/photos/8535230/pexels-photo-8535230.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
      ],
      schedule: [
    ...
    en: {
      ...
      activities: [
        { title: "Debates & discussions", description: "Development of argumentation and critical thinking skills in English", image: "https://images.pexels.com/photos/8612967/pexels-photo-8612967.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
        { title: "Project work", description: "Creating presentations and research projects in English", image: "https://images.pexels.com/photos/8535227/pexels-photo-8535227.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
        { title: "Exam preparation", description: "Systematic preparation for international exams", image: "https://images.pexels.com/photos/8535230/pexels-photo-8535230.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
      ],
      schedule: [
