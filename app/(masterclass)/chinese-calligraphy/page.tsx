...
import { ChevronRight, Check, ArrowRight, Clock, Phone, Landmark, Mail, Globe, ChevronDown, X, Menu, MapPin, Calendar } from 'lucide-react'
            ...
            <ul className="flex gap-6">
              ...
              <li className="relative">
                <button
                  ...
                  className={`flex items-center text-sm font-medium ${activeDropdown === "masterclass" ? "text-[#5C162E]" : "text-gray-700 hover:text-[#5C162E]"}`}
                >
                  {t.nav.masterclass}
                  <ChevronDown
